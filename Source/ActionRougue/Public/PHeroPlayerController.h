...
#include "PHeroPlayerController.generated.h"
...
UCLASS()
class ACTIONROUGUE_API APHeroPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	void AnyKeyInput(const FInputActionValue& Value);
