...
#include "PPowerUp_Action.h"

#include "PActionComponent.h"

void APPowerUp_Action::Interact_Implementation(APawn* InstigatorPawn)
{
	...
	UPActionComponent* ActionComp = Cast<UPActionComponent>(InstigatorPawn->GetComponentByClass(UPActionComponent::StaticClass()));
